...
const LogReg = () => {
    return (
        <div className='w-6/12 mx-auto my-20 shadow-lg'>
            <div className='grid grid-cols-2 gap-3'>
                <div className='flex flex-col items-center justify-center p-10'>
                    <img className='w-2/12 mb-20' src={logo} alt="" />
                    ...
                    <div className='flex items-center justify-center bg-blue-500 p-1'>
                        <div className='bg-white p-3'>
                            <img className='w-10 h-full' src={googleIcon} alt="" />
                        </div>
                        <div className='text-2xl p-4 py-3 text-white fount-bold '>
